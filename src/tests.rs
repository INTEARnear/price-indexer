...
async fn test_prices() {
    ...
    tokens
        .update_pool("REF-3879", near_usdt_pool, near_usdt_data, 0)
        .await;
    assert_eq!(
        tokens
            .tokens
    ...
    tokens
        .update_pool("REF-4663", intel_near_pool, intel_near_data, 0)
        .await;
    assert_eq!(
        format!(
            "{}",
    ...
    tokens
        .update_pool("TEST-42", intel_usdt_pool, intel_near_data, 0)
        .await;
    assert_eq!(
        tokens
            .tokens
